        ...
        <div className="w-full flex justify-center mt-12 px-5">
            <div className="bg-white rounded-[18px] shadow-[0_4px_18px_rgba(49,130,206,0.1)] p-8 max-w-[420px] w-full border border-gray-100">
                <div className="text-center mb-6">
                    <h2 className="font-['Pacifico',cursive] text-[#8338ec] text-3xl m-0 mb-2">Join Skillspotter</h2>
                    <p className="text-gray-500 text-sm">Create an account to start booking helpers</p>
                </div>
                ...
                <p className="text-center mt-6 text-sm text-gray-600">
                    Already have an account? <Link to="/login" className="text-[#3182ce] font-semibold hover:underline">Log in</Link>
                </p>
            </div>
        </div>
    );
